  ...
  return(
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/recipe' element={<Recipe recipe={recipe} setUserInput={setUserInput} addFavorite={addFavorite} setAddFevorite={setAddFevorite}/>}></Route>
        <Route path="/favorite" element = {<Favorite recipe={recipe} setAddFavorite={setAddFavorite}/>}></Route>
