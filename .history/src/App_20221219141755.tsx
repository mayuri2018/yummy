...
function App() {
  ...
  const [addFavorite, setAddFevorite]=useState<Meal[]>([]);
  ...
  return(
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/recipe' element={<Recipe recipe={recipe} setUserInput={setUserInput} addFavoret={addFavorite} setAddFevorite={setAddFevorite}/>}></Route>
